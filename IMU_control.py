...
while True:
    ...
    print ("accelerometer xout: ", ("%6d" % beschleunigung_xout), " scaled: ", beschleunigung_xout_skaliert)
    print ("accelerometer yout: ", ("%6d" % beschleunigung_yout), " scaled: ", beschleunigung_yout_skaliert)
    print ("accelerometer zout: ", ("%6d" % beschleunigung_zout), " scaled: ", beschleunigung_zout_skaliert)
